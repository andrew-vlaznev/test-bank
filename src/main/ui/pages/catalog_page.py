...
class CatalogPage:
    ...
    def __init__(self, page: Page):
        self.page = page
        self.products_cards = page.locator(".inventory_item")
    ...
    def get_product_names(self) -> list[str]:
        return self.product_cards.locator(".inventory_item_price").all_text_contents()
    ...
    def open_product_details(self, product_name: str):
        card = self.products_cards.filter(has_text=product_name)
        ...
        detail_name = self.page.locator(".inventory_item_name").inner_text()
        detail_price_text = self.page.locaator(".inventory_item_name").inner_text()
